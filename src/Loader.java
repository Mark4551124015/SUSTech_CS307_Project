...
public class Loader  {
    ...
    public void loadFromFile_V5 (String filePath, int max) {
        int cnt;
        int MAXRECORD = max;
        try {
            JDBC jb = new JDBC();
    ...
    public void loadFromFile_V4 (String filePath, int max) {
        int cnt;
        int MAXRECORD = max;
        try {
            JDBC jb = new JDBC();
    ...
    public void loadFromFile_V3 (String filePath, int max) {
        int cnt;
        int MAXRECORD = max;
        try {
            JDBC jb = new JDBC();
            ...
            while ((line = br.readLine()) != null && cnt <= MAXRECORD) {
                ...
                exportCity.executeUpdate();
                importCity.executeUpdate();
                cityR.executeUpdate();
                cityD.executeUpdate();
                shipment.executeUpdate();
                container.executeUpdate();
                ship.executeUpdate();
                courierR.executeUpdate();
                courierD.executeUpdate();
                import_detail.executeUpdate();
                export_detail.executeUpdate();
                retrieval.executeUpdate();
    ...
    public void loadFromFile_V2 (String filePath, int max)  {
        int MAXRECORD = max;
        int cnt = 0;
        try {
            long startTime = System.currentTimeMillis();
    ...
    public void loadFromFile_V1 (String filePath, int max)  {
        int MAXRECORD = max;
        int cnt = 0;
        try {
            long startTime = System.currentTimeMillis();
