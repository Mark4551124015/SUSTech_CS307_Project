...
public class RoughSpeedTest {
    static int importDataNumber = 10000;
    static int insertNumber = 100;
    static int updateNumber = 100;
    static int deleteNumber = 100;
    static int queryNumber = 100;
    ...
    public void updateTest() throws IOException {
        ...
        Courier templateCourier = new Courier(null, null, null, "1008611", "上海", "Apple");
        // Timer
        long startTime = System.currentTimeMillis();
        ...
        // Timer
        long endTime = System.currentTimeMillis();
        System.out.printf("Updated %d records, speed: %.2f records/s\n", counter, (float)insertNumber/(endTime - startTime) * 1000);
    ...
    public void queryTest() throws IOException {
        ...
        while (nextLine != null && counter < queryNumber) {
            String[] piece = nextLine.split(",", -1);
            String ItemName = piece[0];
            FileDBManager.getFreshShipments().select(shipment -> shipment.itemName.equals(ItemName));
        ...
        // Timer
        long endTime = System.currentTimeMillis();
        System.out.printf("Queried %d records, speed: %.2f records/s\n", counter, (float)insertNumber/(endTime - startTime) * 1000);
